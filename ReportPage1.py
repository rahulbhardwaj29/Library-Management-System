...
class Report1Class:
    def __init__(self,hwindow):
        ...
        self.window.title("library_management\Student Report")
        ...
        #------------------ table ---------------------
        self.mytable1 = Treeview(self.window,columns=['c1','c2','c3','c4','c5','c6','c7','c8','c9'],height=20)
        ...
        self.mytable1.column('c2',width=150,anchor='s')
        ...
        self.mytable1.column('c7',width=150,anchor='center')
        self.mytable1.column('c8',width=200,anchor='center')
        self.mytable1.column('c9',width=150,anchor='center')
    ...
    def getPrintout(self):
        ...
        headings = ['Rollno', 'Name', 'Phone No', 'Gender', 'DOB', 'Address', 'Department', 'Course','Book Issued']
    ...
    def showAllData(self):
        try:
            ...
            if rowdata:
                for row in rowdata:
                    myr1 = [row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[7],row[8]]
