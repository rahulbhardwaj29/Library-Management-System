...
class CreateAdminClass:
    ...
    def __init__(self):
        self.window = Tk()
        self.window.title("library_management\Create Admin")
        ...
        self.hdlbl = Label(self.window,text='Welcome to My library_management',background=mycolor2,font=('Cambria',20,'bold'))
